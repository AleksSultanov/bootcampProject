...
export function MainForm() {
  ...
  return (
    <div
      className={`${classes.main}  ${isOpenPanel.Bar ? classes.openbar : ""}`}
    >
      <div
        className={`${classes.bar}  ${isOpenPanel.Bar ? classes.openbar : ""}`}
      >
        <ColvirToolBar isOpenBar={isOpenPanel.Bar} onSetOpenBar={onOpenBar} />
      </div>
      <div
